...
if __name__ == '__main__':
    ...
    # Setup arguments
    parser.add_argument('--objective', type=str, choices=objectives.OBJECTIVES, default='DANN')
    ...
    if flags.mode == 'train':
        ...
        if dataset.TASK == 'regression':
            ...
            t.add_row(['eval'] 
                    + ["{:.4f} :: {:.4f}".format(record[str(e)+'_in_acc'], record[str(e)+'_out_acc']) for e in dataset.ENVS] 
