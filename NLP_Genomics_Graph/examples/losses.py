...
from wilds.common.metrics.loss import ElementwiseLoss, Loss, MultiTaskLoss, CrossEntropyLabelSmooth
...
def initialize_loss(loss, config):
    ...
    elif loss == 'cross_entropy_ls':
        return CrossEntropyLabelSmooth(eps=config.eps, reduction='none')
